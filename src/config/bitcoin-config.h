...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The provigencoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "provigencoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/provigencoin-project/provigencoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "provigencoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "provigencoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "provigencoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://provigencoin.org/"

...
#if defined(NDEBUG)
# error "provigencoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "provigencoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("provigencoin-scriptch");

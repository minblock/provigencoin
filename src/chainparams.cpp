...
{
    const char* pszTimestamp = "4/8/2020 Provigen Networks: Now accepting luckgeneroshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586341109, 102610, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9f92d96d1eb514647c86fd737bd619d6637a20a88808bba1effd68875b3184cc"));
        assert(genesis.hashMerkleRoot == uint256S("0x6630404fbf982a39ac6efb9627c3156aa9e4fafefcd7bcf2c28fcb5294197aca"));
        ...
        vSeeds.emplace_back("seed-a.provigencoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.provigencointools.com");
        vSeeds.emplace_back("dnsseed.provigencoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 689831, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4aa5767d6fc68756e1c5e179e49e4715355949c0057e2f177db45e2743cb83cd"));
        assert(genesis.hashMerkleRoot == uint256S("0x6630404fbf982a39ac6efb9627c3156aa9e4fafefcd7bcf2c28fcb5294197aca"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.provigencointools.com");
        vSeeds.emplace_back("seed-b.provigencoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7ecab5c7f94c01d39fb888199776bfe608a04b2e64768601b79486f292b645fe"));
        assert(genesis.hashMerkleRoot == uint256S("0x6630404fbf982a39ac6efb9627c3156aa9e4fafefcd7bcf2c28fcb5294197aca"));

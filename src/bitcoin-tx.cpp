...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " provigencoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  provigencoin-tx [options] <hex-tx> [commands]  Update hex-encoded provigencoin transaction\n" +
            "or:     provigencoin-tx [options] -create [commands]   Create hex-encoded provigencoin transaction\n" +
            "\n";

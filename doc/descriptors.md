# Support for Output Descriptors in provigencoin Core

Since provigencoin Core v0.17, there is support for Output Descriptors. This is a
...
on provigencoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing provigencoin Core wallets, a convenience function `combo` is

...
pkgdatadir = $(datadir)/provigencoin
pkgincludedir = $(includedir)/provigencoin
pkglibdir = $(libdir)/provigencoin
pkglibexecdir = $(libexecdir)/provigencoin
...
ACLOCAL = ${SHELL} /provigencoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /provigencoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /provigencoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /provigencoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = provigencoin-cli
BITCOIN_DAEMON_NAME = provigencoind
BITCOIN_GUI_NAME = provigencoin-qt
BITCOIN_TX_NAME = provigencoin-tx
BITCOIN_WALLET_TOOL_NAME = provigencoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The provigencoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = provigencoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /provigencoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = provigencoin
PACKAGE_BUGREPORT = https://github.com/provigencoin-project/provigencoin/issues
PACKAGE_NAME = provigencoin Core
PACKAGE_STRING = provigencoin Core 0.18.1
PACKAGE_TARNAME = provigencoin
PACKAGE_URL = https://provigencoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /provigencoin
abs_srcdir = /provigencoin
abs_top_builddir = /provigencoin
abs_top_srcdir = /provigencoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /provigencoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/provigencoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/provigencoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/provigencoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/provigencoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)

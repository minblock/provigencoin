...
"""Verify that starting provigencoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start provigencoin with -h for help text")
        ...
        self.log.info("Start provigencoin with -version for version information")
        ...
        self.log.info("Start provigencoind with -fakearg to make sure it does not start")
